...
$fd = fopen("/tmp/tmplist.php", 'w');
fwrite($fd, $result['content']);
fclose($fd);



if (file_exists('/tmp/tmplist.php')) {
	
	define ('EDITFILE', '/tmp/tmplist.php');
...
<button><a class="ab-btn asphalt" href='/admin/pages_list.php'>Редактирование всех страниц</a></button>
...
<div class="ab-row">
<div class="ab-col12">
<p style="color:white;margin:10px 0 0 -15px;">Страница: <?php echo $result['header'];	?></p>
...
<div class="ab-row">			   
		...
		if (isset($_GET['red_id']) && isset($_POST['areacode']) && isset($_POST['submit'])) {
			$sql2 = mysqli_query($link, "UPDATE `pages` SET `content` = '{$_POST['areacode']}' WHERE `id`={$_GET['red_id']}");
		}
...
?>
                ...
                <form action="" method="post" name='333' >
